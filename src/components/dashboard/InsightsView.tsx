    ...
    <div className="space-y-5 animate-in fade-in duration-150">
      ...
      <div className="bg-white rounded-xl p-5 sm:p-6 border border-slate-200/80 shadow-[0_1px_2px_rgba(0,0,0,0.02)] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5">
            <h1 className="text-lg sm:text-xl font-semibold text-slate-900 tracking-tight">Analytics & Insights</h1>
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs font-medium px-2.5 py-1 bg-slate-100 border border-slate-200 rounded-md text-slate-700">
            Last 30 Days
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5">
        ...
        <div className="bg-white p-4.5 rounded-xl border border-slate-200/80 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
          ...
          <p className="text-[11px] text-slate-400 mt-0.5">Autonomous 24/7 coverage</p>
        </div>
        ...
        <div className="bg-white p-4.5 rounded-xl border border-slate-200/80 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-2xl font-bold text-slate-900 tracking-tight">~86 hrs</span>
          </div>
          <p className="text-[11px] text-slate-400 mt-0.5">Equivalent to 2 full-time reps</p>
        </div>
        ...
        <div className="bg-white p-4.5 rounded-xl border border-slate-200/80 shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
          ...
          <div className="mt-2 flex items-baseline gap-1.5">
            <span className="text-2xl font-bold text-slate-900 tracking-tight">4.7</span>
            <span className="text-xs text-slate-400 font-medium">/ 5.0</span>
            <Star className="w-3.5 h-3.5 text-amber-500 fill-amber-500 ml-1" />
          </div>
          <p className="text-[11px] text-slate-400 mt-0.5">Based on 320 customer ratings</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl p-5 sm:p-6 border border-slate-200/80 shadow-[0_1px_2px_rgba(0,0,0,0.02)] space-y-3.5">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-xs font-semibold text-slate-900">Conversation & Resolution Volume</h3>
              <p className="text-[11px] text-slate-400">Daily incoming inquiries vs autonomous resolutions</p>
            </div>
          </div>
        ...
        {/* Top Customer Topics */}
        <div className="bg-white rounded-xl p-5 sm:p-6 border border-slate-200/80 shadow-[0_1px_2px_rgba(0,0,0,0.02)] space-y-3.5">
          <div>
            <h3 className="text-xs font-semibold text-slate-900">Top Customer Topics</h3>
            <p className="text-[11px] text-slate-400">Most frequent inquiry categories</p>
          </div>
            ...
            {topQuestions.map((q, idx) => (
              <div key={idx} className="space-y-1">
                <div className="flex items-center justify-between text-xs font-medium text-slate-800">
                  ...
                  <span className="text-slate-500 font-mono">{q.percentage}%</span>
                </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200/80 shadow-[0_1px_2px_rgba(0,0,0,0.02)] overflow-hidden">
        <button
          ...
          className="w-full p-4.5 flex items-center justify-between text-left hover:bg-slate-50 transition-colors cursor-pointer"
        >
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-slate-100 flex items-center justify-center text-slate-600 border border-slate-200/60">
              <Cpu className="w-4 h-4" />
            </div>
            <div>
              <h4 className="text-xs font-semibold text-slate-900">Developer Metrics & LLM Telemetry</h4>
              <p className="text-[11px] text-slate-400">Token usage, retrieval latency, and model performance metrics</p>
            </div>
          </div>
          <div className="flex items-center gap-1.5 text-xs font-medium text-slate-700">
            <span>{showAdvanced ? 'Hide Telemetry' : 'Show Telemetry'}</span>
            {showAdvanced ? <ChevronUp className="w-3.5 h-3.5" /> : <ChevronDown className="w-3.5 h-3.5 text-slate-400" />}
          </div>
        </button>

        {showAdvanced && (
          <div className="p-4.5 pt-0 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-3 gap-3 bg-slate-50/50 animate-in fade-in duration-150">
            <div className="p-3.5 bg-white rounded-lg border border-slate-200 shadow-2xs space-y-1">
              <span className="text-[10px] font-medium font-mono text-slate-400 uppercase tracking-wider">Token Consumption</span>
              <p className="text-lg font-bold text-slate-900">342,800 tokens</p>
              <p className="text-[10px] text-slate-400 font-mono">Prompt: 280k · Completion: 62.8k</p>
            </div>

            <div className="p-3.5 bg-white rounded-lg border border-slate-200 shadow-2xs space-y-1">
              <span className="text-[10px] font-medium font-mono text-slate-400 uppercase tracking-wider">Embedding Latency</span>
              <p className="text-lg font-bold text-emerald-600">42 ms</p>
              <p className="text-[10px] text-slate-400 font-mono">Dense cosine similarity</p>
            </div>

            <div className="p-3.5 bg-white rounded-lg border border-slate-200 shadow-2xs space-y-1">
              <span className="text-[10px] font-medium font-mono text-slate-400 uppercase tracking-wider">FastAPI p95 Latency</span>
              <p className="text-lg font-bold text-slate-900">1.18 s</p>
              <p className="text-[10px] text-slate-400 font-mono">Asynchronous streaming</p>
            </div>
          </div>
        )}
      </div>
